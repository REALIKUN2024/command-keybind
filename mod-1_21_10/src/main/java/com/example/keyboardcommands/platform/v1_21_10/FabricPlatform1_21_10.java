package com.example.keyboardcommands.platform.v1_21_10;
...
/**
 * Minecraft 1.21.10 平台实现（官方映射）。
 *
 * <p>差异：发指令用 {@code LocalPlayer.chat}，发消息用
 * {@code displayClientMessage}，按键注册走 keybinding.v1 包，
 * KeyMapping 分类为字符串。</p>
 */
public final class FabricPlatform1_21_10 implements Platform {

	/** 本模组专属按键分类（KeyMapping.Category，显示名经 id.toLanguageKey("key.category") 生成）。 */
	public static final KeyMapping.Category CATEGORY = KeyMapping.Category.register(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "command-keybind"));
	...
	public void sendSystemMessage(String translationKey, Object... args) {
		...
		minecraft().player.displayClientMessage(Component.translatable(translationKey, args), false);
	}
	...
	/** {@link BoundKey} 的 1.21.10 实现，包装原版 {@link KeyMapping}。 */
