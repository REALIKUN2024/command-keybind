package com.example.keyboardcommands.platform.v1_19_4;
...
/**
 * Minecraft 1.19.4 平台实现（官方映射）。
 *
 * <p>差异：发指令用 {@code LocalPlayer.chat}，发消息用
 * {@code displayClientMessage}，按键注册走 keybinding.v1 包，
 * KeyMapping 分类为字符串。</p>
 */
public final class FabricPlatform1_19_4 implements Platform {
	...
	/** {@link BoundKey} 的 1.19.4 实现，包装原版 {@link KeyMapping}。 */
