...
import com.example.keyboardcommands.platform.v1_21_8.FabricPlatform1_21_8;
import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;

public class KeyboardCommandsClient implements ClientModInitializer {
	public static final Platform PLATFORM = new FabricPlatform1_21_8();
	...
	public void onInitializeClient() {
		...
		Constants.LOGGER.info("[Command Keybind] Client initialized (1.21.8)");
	}
}
