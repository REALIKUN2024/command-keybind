	...
	private static final class CommandList extends ContainerObjectSelectionList<CommandList.Entry> {
		...
		private final class Entry extends ContainerObjectSelectionList.Entry<Entry> {
			...
			public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
				...
				this.commandBox.setY(y);
				this.commandBox.setX(this.getContentX());
				this.commandBox.extractRenderState(graphics, mouseX, mouseY, a);
				int x = CommandList.this.scrollBarX() - 10 - this.deleteButton.getWidth();
