...
import com.example.keyboardcommands.platform.v1_18.FabricPlatform1_18;
import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;

public class KeyboardCommandsClient implements ClientModInitializer {
	public static final Platform PLATFORM = new FabricPlatform1_18();
	...
	public void onInitializeClient() {
		...
		Constants.LOGGER.info("[Command Keybind] Client initialized (1.18)");
	}
}
