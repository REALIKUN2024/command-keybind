...
import com.example.keyboardcommands.platform.v26_2.FabricPlatform26_2;
import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;

public class KeyboardCommandsClient implements ClientModInitializer {
	public static final Platform PLATFORM = new FabricPlatform26_2();
	...
	public void onInitializeClient() {
		...
		ClientTickEvents.END_CLIENT_TICK.register(client -> {
			boolean inGame = client.gui.screen() == null && client.player != null;
			BINDING_MANAGER.onEndTick(inGame);
		});
		Constants.LOGGER.info("[Command Keybind] Client initialized (26.2)");
	}
}
