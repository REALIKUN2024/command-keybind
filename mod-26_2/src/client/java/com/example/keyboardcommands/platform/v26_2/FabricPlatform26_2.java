package com.example.keyboardcommands.platform.v26_2;
...
/**
 * Minecraft 26.2 平台实现（占位，待 API 差异确认后修正）。
 *
 * <p>全工程唯一接触 Minecraft 具体类的业务入口，
 * 将来移植其他版本时新增对应实现类即可。</p>
 */
public final class FabricPlatform26_2 implements Platform {

	/** 本模组专属的按键分类（在 Controls 界面独立显示，翻译键 key.category.command-keybind.command-keybind）。 */
	public static final KeyMapping.Category CATEGORY =
		KeyMapping.Category.register(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "command-keybind"));
